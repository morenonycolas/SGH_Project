...
/**
 ...
 @brief: se encuentra la pagina para la actualizacion de ambientes
 @brief:'descripcion'
 @date 28/03/2017
          ...
          <table width="527" border="0" align="center">
            <tr>
              ...
              <td width="307"><div align="center"><span class="Estilo1"></span>
                      ...
                      <label>
                      <input name="descripcion" value="{{$ambiente->descripcion}}" type="text" size="30" placeholder="Numero de ambiente"/>
                      </label>
              </div></td>
            </tr>
            <tr>
