...
/**
 ...
 @brief: se encuentra la pagina para la actualizacion de informacion de una ficha
 @brief:'numero_ficha','programa','grupo'
 @date: 28/03/2017
          ...
          <table width="527" border="0" align="center">
            ...
            <tr>
              ...
              <td><div align="center"><span class="Estilo1"></span>
                      <label>
                      <input name="numero_grupo" value="{{$ficha->numero_grupo}}" type="text" size="30" placeholder="Numero de Grupo"/>
                      </label>
              </div></td>
            </tr>
